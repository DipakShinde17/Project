...
Identified trends, patterns, and business insights through visualization

🔹 E-commerce Chatbot
Developed an AI-based chatbot for handling customer queries in an e-commerce environment
Implemented Natural Language Processing (NLP) techniques
Helps users with product search, FAQs, and order-related queries

🔹 Resume Shortlisting System
Built a system to automatically filter and rank resumes
